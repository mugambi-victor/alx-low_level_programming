...
int check_elf(unsigned char *e_identify);
void print_magic(unsigned char *e_identify);
int print_class(unsigned char *e_identify);
 ...
 * @e_identify: A pointer to an array containing the ELF magic numbers.
 *
 ...
 * @e_identify: A pointer to an array containing the ELF class.
 */
int print_class(unsigned char *e_identify)
{
	printf("  Class:                             ");
 ...
 * @e_identify: A pointer to an array containing the ELF version.
 */
void print_version(unsigned char *e_identify)
{
	printf("  Version:                           %d",
 ...
 * @e_identify: A pointer to an array containing the ELF ABI version.
 */
void print_abi(unsigned char *e_identify)
{
